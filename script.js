...
document.getElementsByClassName('btn-buy')[0].addEventListener('click', bayar);
function bayar() {
...
function updateTotal() {
  ...
  cartItems.forEach((product) => {
    ...
    let price = parseFloat(
      priceElement.innerHTML.replace('Rp.', '').replace('.', '')
    );
  ...
  totalValue.innerHTML = 'Rp.' + total.toLocaleString('es') + ',00';
